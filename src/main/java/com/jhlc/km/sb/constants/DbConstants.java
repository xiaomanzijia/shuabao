...
public class DbConstants {
    ...
    public static final String       DB_NAME                                       = "shuabao.db";
    public static final int          DB_VERSION                                    = 1;

    private static final String      TERMINATOR                                    = ";";

    /** image sdcard cache table **/
    public static final StringBuffer CREATE_ANTIQUE_CATEGORY_TABLE_SQL           = new StringBuffer();
//    public static final StringBuffer CREATE_ANTIQUE_CATEGORY_TABLE_INDEX_SQL     = new StringBuffer();
    public static final String       ANTIQUE_CATEGORY_TABLE_TABLE_NAME           = "antiquecategory";
    public static final String       ANTIQUE_CATEGORY_TABLE_ID                   = android.provider.BaseColumns._ID;
    public static final String       ANTIQUE_CATEGORY_TABLE_CATEGORY_ID          = "cid";
    public static final String       ANTIQUE_CATEGORY_TABLE_CATEGORY_NAME        = "cname";

//    public static final String       ANTIQUE_CATEGORY_TABLE_INDEX_TAG            = "antique_category_table_index_tag";
//    public static final String       ANTIQUE_CATEGORY_TABLE_INDEX_URL            = "antique_category_table_index_url";
//
//    public static final int          ANTIQUE_CATEGORY_TABLE_ID_INDEX             = 0;
//    public static final int          ANTIQUE_CATEGORY_TABLE_CATEGORY_ID_INDEX    = 1;
//    public static final int          ANTIQUE_CATEGORY_TABLE_CATEGORY_NAME_INDEX  = 2;
//    public static final int          ANTIQUE_CATEGORY_TABLE_PATH_INDEX           = 3;
//    public static final int          ANTIQUE_CATEGORY_TABLE_ENTER_TIME_INDEX     = 4;
//    public static final int          ANTIQUE_CATEGORY_TABLE_LAST_USED_TIME_INDEX = 5;
//    public static final int          ANTIQUE_CATEGORY_TABLE_USED_COUNT_INDEX     = 6;
//    public static final int          ANTIQUE_CATEGORY_TABLE_PRIORITY_INDEX       = 7;
//    public static final int          ANTIQUE_CATEGORY_TABLE_IS_EXPIRED_INDEX     = 8;
//    public static final int          ANTIQUE_CATEGORY_TABLE_IS_FOREVER_INDEX     = 9;
...
//    public static final int          HTTP_CACHE_TABLE_TYPE_INDEX                   = 5;
    ...
    static {
         ...
         **/
        CREATE_ANTIQUE_CATEGORY_TABLE_SQL.append("CREATE TABLE ").append(ANTIQUE_CATEGORY_TABLE_TABLE_NAME);
        CREATE_ANTIQUE_CATEGORY_TABLE_SQL.append(" (").append(ANTIQUE_CATEGORY_TABLE_ID)
                .append(" integer primary key autoincrement,");
        CREATE_ANTIQUE_CATEGORY_TABLE_SQL.append(ANTIQUE_CATEGORY_TABLE_CATEGORY_ID).append(" text,");
        CREATE_ANTIQUE_CATEGORY_TABLE_SQL.append(ANTIQUE_CATEGORY_TABLE_CATEGORY_NAME).append(" text)");
        CREATE_ANTIQUE_CATEGORY_TABLE_SQL.append(TERMINATOR);

//        CREATE_ANTIQUE_CATEGORY_TABLE_INDEX_SQL.append("CREATE INDEX ").append(ANTIQUE_CATEGORY_TABLE_INDEX_TAG)
//                .append(" ON ").append(ANTIQUE_CATEGORY_TABLE_TABLE_NAME).append("(")
//                .append(ANTIQUE_CATEGORY_TABLE_CATEGORY_ID).append(")").append(TERMINATOR).append("CREATE INDEX ")
//                .append(ANTIQUE_CATEGORY_TABLE_INDEX_URL).append(" ON ").append(ANTIQUE_CATEGORY_TABLE_TABLE_NAME)
//                .append("(").append(ANTIQUE_CATEGORY_TABLE_CATEGORY_NAME).append(")").append(TERMINATOR);
//
//        /**
