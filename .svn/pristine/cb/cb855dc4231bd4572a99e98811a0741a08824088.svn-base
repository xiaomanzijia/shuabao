 ...
 */
public class CommentHotNewActivity extends BaseActivity {
    ...
    public void initView() {
        super.initView();
        antiqueid = getIntent().getStringExtra(Constants.INTENT_TRESUREDETAIL_COMMENTHOTNEW_TRESREID);
        if(!StringUtils.isBlank(antiqueid)){
            FragmentPagerAdapter adapter = new CommentHotNewAdapter(getSupportFragmentManager(),getApplicationContext(),antiqueid);
